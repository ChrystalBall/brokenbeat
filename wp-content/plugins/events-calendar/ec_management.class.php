...
?>
    ...
    <form name="EC_addEventForm" id="addEventform" method="post" action="?page=events-calendar" onSubmit="return TitleTst();">
      <p class="submit">
      ...
      <table summary="Edit Form2" class="editform" width="100%" cellspacing="2" cellpadding="5">
        <tr>
          <th width="33%" scope="row" valign="top" style="text-align:right;"><label for="statusPost"><?php _e('Which Post Status ?','events-calendar'); ?></label></th>
          <td width="67%">
    ...
    // <![CDATA[      
      function TitleTst() {        
        if (document.forms.EC_addEventForm.EC_title.value=="") {
          alert("<?php _e('Event Title can not be blank!','events-calendar'); ?>");
          return false;           
        } 
        return true; 
      }
      ...
      jQuery("#EC_doPost").change(function(){
          if (jQuery("#EC_doPost").is(":checked")) {          
            jQuery("#showSelectStatusPost").show("slow");
          } else {
            jQuery("#showSelectStatusPost").hide("slow");
...
?>
    ...
    <form name="EC_editEventForm" method="post" action="?page=events-calendar" onSubmit="return postIDtst();".>
      <p class="submit">
      ...
      <table summary="Edit Form" class="editform" width="100%" cellspacing="2" cellpadding="5">
        ...
        <tr>
          <th width="33%" scope="row" valign="top" style="text-align:right;"><label for="postID"><?php _e('Post ID','events-calendar'); ?></label></th>
    ...
    // <![CDATA[ 
      function postIDtst() {
        ...
        if (isNaN(m)) {
          alert("<?php _e('Post ID must be a number!','events-calendar'); ?>");
          return false;           
        } else {
...
?>
    ...
    <form name="optionsEventsCalendar" method="post" action="?page=events-calendar-options" onLoad="">
      ...
      <table summary="Edit Form1" class="editform" width="100%" cellspacing="2" cellpadding="5">
        ...
        <tr>
          <th width="33%" scope="row" valign="top" style="text-align:right;"><label for="dateFormatWidget"><?php _e('Widget Calendar Dates','events-calendar'); ?></label></th>
          <td width="67%"><input type="text" name="dateFormatWidget" id="dateFormatWidget" value="<?php echo $options['dateFormatWidget'];?>" /></td>
        </tr>
        <tr>
          <th width="33%" scope="row" valign="top" style="text-align:right;"><label for="timeFormatWidget"><?php _e('Widget Calendar Times','events-calendar'); ?></label></th>
        ...
        <tr>
          <th width="33%" scope="row" valign="top" style="text-align:right;"><label for="timeFormatLarge"><?php _e('Large Calendar Times','events-calendar'); ?></label></th>
        ...
        <table summary="Edit Form3" class="editform" width="100%" cellspacing="2" cellpadding="5">
        <tr>
    ...
    // <![CDATA[ 
      ...
      jQuery("#EC_adaptedCSS").change(function(){
          if (jQuery("#EC_adaptedCSS").is(":checked")) {
            jQuery("#switchCSSoptions").hide("slow");
          } else {
            jQuery("#switchCSSoptions").show("slow");
