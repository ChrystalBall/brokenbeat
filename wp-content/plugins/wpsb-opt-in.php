...
/*
    Copyright 2008 eDisplay Srl (http://www.sendblaster.com/)
...
<input type="hidden" name="wpsb_hidden" value="SAb13c">
    ...
    <table width="100%" cellspacing="2" cellpadding="5" class="optiontable editform">
      ...
      <tr valign="top"> 
        <th width="33%" scope="row">Message to subscriber, subject:</th>
        <td> 
          <input type="text" name="wpsb_email_subject" id="wpsb_email_subject" value="<?php echo $email_subject; ?>" size="40">
        </td>
      </tr>
      <tr valign="top"> 
        <th width="33%" scope="row">Message to subscriber, content:</th>
        <td> 
          <p> 
    ...
    <table width="100%" cellspacing="2" cellpadding="5" class="optiontable editform">
      ...
      <tr valign="top"> 
        <th width="33%" scope="row">Double opt-in failure:</th>
        <td>
          <input type="text" name="wpsb_dbl_fail" id="wpsb_dbl_fail" value="<?php echo $dbl_fail; ?>" size="40">
        </td>
      </tr>
      <tr valign="top"> 
        <th width="33%" scope="row">Double opt-in success:</th>
        <td>
