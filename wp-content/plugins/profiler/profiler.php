...
function pf_uids($start, $records)
{
	global $wpdb;
...
function pf_output_single($id)
{
	...
	if(get_option('pf_show_emails') == 'yes')
		$output .= "<p>Email:  <a href=" . "mailto:" . $user_email . ">$user_email</a></p>";
...
function pf_output_directory($start, $records, $lastpage)
{
	...
	foreach($uids as $key=>$value)
	{
		...
		if(get_option('pf_roles_enabled') == 'yes')
			$output .= "<td>" . $role . "</td>";
		if(get_option('pf_show_emails') == 'yes')
			$output .= "<td><a href=" . "mailto:" . $vars['user_email'] . ">" . $vars['user_email'] . "</a></td>";
...
<input type="hidden" name="page_options" value="pf_users_per_page, pf_recent_posts_per_profile, pf_recent_comments_per_profile, pf_show_gravatars, pf_show_emails, pf_gravatar_size, pf_show_roles_admin, pf_show_roles_subscriber, pf_show_roles_author, pf_show_roles_editor, pf_show_roles_contributor, pf_show_roles_none, pf_roles_enabled" />
