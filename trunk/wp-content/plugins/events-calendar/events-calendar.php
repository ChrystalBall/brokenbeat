...
Description: There are options under the widget options to specify the view of the calendar in the sidebar. The widget can be a list for upcoming events or a calendar. If you do not have a widget ready theme then you can place '&lt;?php SidebarEventsCalendar();?&gt;'?, or '&lt;?php SidebarEventsList();?&gt;' for an event list, in the sidebar.php file of your theme. If you want to display a large calendar in a post or a page, simply place "[[EventsCalendarLarge]]" in the html of the post or page. Make sure to leave off the quotes. Events-Calendar should normally be taken care over by <a href="http://heirem.fr">Heirem</a> in the future. More informations and support <a href="http://heirem.fr">here</a>
Version: 6.5.2.1
Author: Luke Howell
