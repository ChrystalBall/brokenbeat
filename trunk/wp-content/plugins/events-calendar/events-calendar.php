...
Description: There are options under the widget options to specify the view of the calendar in the sidebar.  The widget can be a list for upcoming events or a calendar.  If you do not have a widget ready theme then you can place '&lt;?php sidebarEventsCalendar();?&gt;' in the sidebar file.  If you want to display a large calendar in a post or a page, simply place "[[EventsCalendarLarge]]" in the html of the post or page.  Make sure to leave off the quotes. Events-Calendar should normally be taken care over by Heirem in the future. More informations about at http://heirem.fr.
Version: 6.5.1
Author: Luke Howell
...
<?php
  ...
  $plugins = get_plugins('/cforms');
  /* WARNING :  The following lines were added to version 6.5.0 due to the problems encountered with the plugin cforms. 
                But we realized that prevented months navigation in the calendars on other blogs. 
                ---------------------------------
                These lines have become optional! 
                ---------------------------------
                Test them if you encounter jQuery conflicts between your activated plugins and Events-Calendar.
                If you believe these lines may be an option plugin then say it on heirem.fr
  */
  /* This code is optional : just remove the slashes and stars that surrounds if you want to activate it. */
  /*
  // $plugins = get_plugins('/cforms');
  // if (!$plugins=='') {
    ...
    echo '// <![CDATA[',"\n\t";
      echo 'var dom = {};',"\n\t";
      echo 'dom.query = jQuery.noConflict(true);',"\n\t";
      echo '//]]>',"\n";
    echo '  </script>',"\n";
  // }
  */
