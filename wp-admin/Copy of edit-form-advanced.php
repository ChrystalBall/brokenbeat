...
<fieldset id="eventdiv">
	<legend><?php _e('Event Date (Enter in dd-mm-yyyy format for proper linking); ?></legend>
	<div><input type="text" name="event_input" class="event-input" id="event-input" size="30" tabindex="4" value="<?php echo get_events_to_edit( $post_ID ); ?>" /></div>
</fieldset>
